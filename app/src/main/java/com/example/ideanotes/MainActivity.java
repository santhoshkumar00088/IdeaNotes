...
import com.example.ideanotes.auth.Login;
import com.example.ideanotes.auth.Register;
import com.example.ideanotes.model.Adapter;
import com.example.ideanotes.model.Note;
import com.example.ideanotes.note.AddNote;
import com.example.ideanotes.note.EditNote;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void displayAlert() {
        AlertDialog.Builder warning = new AlertDialog.Builder(this)
                ...
                .setMessage("you are logged in with Temporay Account. Logging out will Delete All the Notes")
                .setPositiveButton("Sync Note", new DialogInterface.OnClickListener() {
                    ...
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        //Todo: delete all the motes created by the Uknown user
    ...
    public class NoteViewHolder extends RecyclerView.ViewHolder {
        ...
        View view;
        CardView mCardview;
        String noteId; // Add a variable to store the note ID
